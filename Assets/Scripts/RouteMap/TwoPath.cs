...
public class TwoPath : MonoBehaviour
{
    ...
    void SpawnButton()
    {
        ...
        //thisButton.GetComponent<ViablePath>().isPathGood = false;
    }
    ...
    private void Update()
    {
        if (oneBehind.GetComponent<ViablePath>().isPathGood == false && !leastOne)
        {
            BadBehind();
        }
        ...
        if (twoBehind.GetComponent<ViablePath>().isPathGood == false && !leastOne)
        {
            BadBehind();
        }
        if (twoBehind.GetComponent<ViablePath>().isPathGood == true)
        {
            GoodBehind();
        }
